...
negligible performance and fast tenough to run as often as we want to detect
regimes.
...
at request rate, unique keys in a sliding window, and bandwidth capabilties. For
...
\begin{figure}[t]
  ...
  subset of keys. Detecting this ``access regimes" leads to a more accurate cache
